...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <!-- START FORM-->
        <h2 class="page-header">Cadastro de Contrato</h2>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id="vencimento" name="vencimento" class="form-control" maxlength="60" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-9">
                                    <label for="observacao">Negociações / Reajuste</label>
                                    <textarea type="text" id="observacao" name="observacao" class="form-control" rows="2" maxlength="125" required></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-9">
                                    <label for="nivel_risco">Nível de risco</label>
                                    <textarea type="text" id="nivel_risco" name="nivel_risco" class="form-control" maxlength="250" rows="5" required></textarea>
                                </div>

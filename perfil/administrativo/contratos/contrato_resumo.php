                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <form method="POST" action="?perfil=contratos&p=pesquisa&sp=pesquisa_contrato_equipamentos"
                                  role="form">
                                <div class="form-group"><input readonly type="hidden" name="idContrato" value="<?= $idContrato ?>">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12" align="center" style="margin-top: 10px">
                                    ...
                                    <label><input readonly type="radio" name="garantia" value="1" <?= $contrato['garantia'] == 1 ? 'checked' : NULL ?>> Sim </label>&nbsp;&nbsp;
                                    <label><input readonly type="radio" name="garantia" value="0" <?= $contrato['garantia'] == 0 ? 'checked' : NULL ?>> Não </label>
                                </div>
                            </div>
